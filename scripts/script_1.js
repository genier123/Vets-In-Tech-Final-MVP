  //------------------------ Write Table Data ----------------------
  let songData = [
    { Artist: 'Drake ft Future & Young Thug', Song: 'Way 2 Sexy', Added:'9-10-2021'},
    { Artist: 'DJ Ryan Wolf ft Soulja Boy, Idd Ack & Ty Bri', Song: 'Hit It', Added:'9-10-2021'},
    { Artist: 'Drake ft Tems', Song: 'Fountains', Added:'9-10-2021'},
    { Artist: 'Bia Nicki Minaj', Song: 'Whole Lotta Money (Remix)', Added:'9-4-2021'},
    { Artist: 'Normani ft Cardi B', Song: 'Wild Side', Added:'9-4-2021'},
    { Artist: 'Lil Nas X ft Jack Harlow', Song: 'Industry Baby', Added:'9-4-2021'},
    { Artist: 'Fat Joe ft Remy Ma & Cool & Dre', Song: 'Back Outside', Added:'9-4-2021'},
    { Artist: 'Pop Smoke ft 42 Dugg & 21 Savage', Song: 'Bought a Million', Added:'9-4-2021'},
    { Artist: 'Megan Thee Stallion', Song: 'Thot Sh-t', Added:'9-4-2021'},
    { Artist: 'City Girls', Song: 'Twerkulater', Added:'9-4-2021'},
    { Artist: 'Beatking ft 2 Chainz & Juicy J', Song: 'SDAB', Added:'9-4-2021'},
    { Artist: 'Belly, The Weeknd, Young Thug', Song: 'Better Believe', Added:'9-4-2021'},
    { Artist: 'Swedish House Mafia', Song: 'It Gets Better', Added:'9-4-2021'},
