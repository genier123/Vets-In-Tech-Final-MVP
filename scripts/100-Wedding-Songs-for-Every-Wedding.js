...
let songData = [
    ...
    { Artist: "Tom Odell", Song: "Grow Old with Me" },
    { Artist: "Daniel Caesar ft. H.E.R.", Song: "Best Part" },
    { Artist: "The Beatles", Song: "Something" },
    { Artist: "Bette Midler", Song: "The Rose" },
    { Artist: "Jackie DeShannon", Song: "What the World Needs Now Is Love" },
    { Artist: "Al Green", Song: "Let's Stay Together" },
    { Artist: "Sixpence None the Richer", Song: "Kiss Me" },
    { Artist: "Jackson 5", Song: "I Want You Back" },
    { Artist: "Lady Antebellum", Song: "Can't Take My Eyes Off You" },
    { Artist: "Queen", Song: "You're My Best Friend" },
    { Artist: "Elton John", Song: "Something About the Way You Look Tonight" },
    { Artist: "The Beatles", Song: "In My Life" },
    { Artist: "Lady Gaga", Song: "Always Remember Us This Way" },
    { Artist: "Ed Sheeran & Andrea Bocelli", Song: "Perfect Symphony" },
    { Artist: "Calum Scott", Song: "You Are the Reason" },
    { Artist: "Ben Folds", Song: "The Luckiest" },
    { Artist: "Taylor Swift", Song: "Lover" },
    { Artist: "Edward Sharpe & The Magnetic Zeros", Song: "Home" },
    { Artist: "Kina Grannis", Song: "Can't Help Falling in Love" },
    { Artist: "Sleeping At Last", Song: "Make You Feel My Love" },
    { Artist: "Ruelle", Song: "I Get to Love You" },
    { Artist: "Vance Joy", Song: "Just You and I" },
];
