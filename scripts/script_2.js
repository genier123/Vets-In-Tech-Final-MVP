...
let songData = [
    ...
    { Artist: 'Cham', Song: 'Ghetto Story', BPM: 97, KEY: 'Em'},
    { Artist: 'Usher', Song: 'U Dont Have To Call', BPM: 97, KEY: 'Em'},
    { Artist: 'The Diplomats', Song: 'I Really Mean It', BPM: 97, KEY: 'Em'},
    { Artist: 'Mystikal ft Pharrell', Song: 'Shake Ya Ass', BPM: 97, KEY: 'Em'},
    { Artist: 'Rick Ross', Song: 'Hustlin', BPM: 97, KEY: 'Em'},
    { Artist: 'Ludacris', Song: 'Southern Hospitality', BPM: 97, KEY: 'Em'},
    { Artist: 'Foxx ft Lil Boosie & Webbie', Song: 'Wipe Me Down', BPM: 97, KEY: 'Em'},
    { Artist: 'Usher ft Lil Jon & Ludacris', Song: 'Yeah', BPM: 97, KEY: 'Em'},
    { Artist: 'Collie Buddz', Song: 'Come Around', BPM: 97, KEY: 'Em'},
    { Artist: 'Justin Timberlake', Song: 'Rock Your Body', BPM: 97, KEY: 'Em'},
    { Artist: 'R. Kelly ft Jay-Z', Song: 'Fiesta (Remix)', BPM: 97, KEY: 'Em'},
    { Artist: 'Prodigy', Song: 'Keep It Thoro', BPM: 97, KEY: 'Em'},
    { Artist: 'Shyne ft Barrington Levy', Song: 'Bad Boyz', BPM: 97, KEY: 'Em'},
    { Artist: 'Missy Elliott', Song: 'Get Ur Freak On', BPM: 97, KEY: 'Em'},
    { Artist: 'YoungBloodz ft. Lil Jon', Song: 'Damn', BPM: 97, KEY: 'Em'},
    { Artist: 'DJ Khaled ft. Akon, T.I., Rick Ross, Fat Joe, Baby & Lil Wayne', Song: 'We Takin Over', BPM: 97, KEY: 'Em'},
    { Artist: 'Jadakiss ft. Styles P', Song: 'We Gonna Make It', BPM: 97, KEY: 'Em'},
    { Artist: 'OutKast', Song: 'Hey Ya', BPM: 97, KEY: 'Em'},
    { Artist: 'CamRon ft. Juelz Santana', Song: 'Oh Boy', BPM: 97, KEY: 'Em'},
